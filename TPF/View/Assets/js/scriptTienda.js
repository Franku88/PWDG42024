...
//       const producto = { idproducto: idProducto, cantidad: 1 };
...
//       alert('Producto agregado: ' + producto['idproducto'] + ' | Cantidad: ' + productoExistente?.cantidad || 1);
...
//       // Actualizar la cantidad de productos en el carrito (puedes llamar una función si lo necesitas)
...
$(document).ready(function () {
    ...
    $('.boton_eliminar').on('click', function () {
      ...
      const idProducto = $(this).attr('id'); // Asumimos que el id del botón contiene el id del producto a eliminar
      ...
      // Opcional: Actualizar la interfaz (quitar el producto del DOM, etc.)
      $(this).closest('.producto').remove(); // Suponiendo que cada producto tiene una clase '.producto'

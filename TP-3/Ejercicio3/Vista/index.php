...
<body>
    ...
    <div class="container mt-5 p-1">
        ...
        <form id="peliculaForm" action="action.php" method="post" enctype="multipart/form-data" novalidate>
            <!-- Título y Actores -->
            <div class="row mb-3">
                <div class="col-md-6">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="genero" id="genero" class="form-select border-customized" required>
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    ...
                    <input type="file" name="imagen" id="imagen" class="form-control border-customized" accept="image/*" required>
                    <div class="invalid-feedback">
                        Por favor, seleccione una imagen para la película.
                    </div>
                </div>
            </div>
